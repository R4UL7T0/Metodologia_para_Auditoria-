...
- **No PIE**: **No está habilitado PIE**, lo que significa que el binario se carga en una dirección fija. Esto hace que sea más fácil para un atacante predecir la ubicación de
